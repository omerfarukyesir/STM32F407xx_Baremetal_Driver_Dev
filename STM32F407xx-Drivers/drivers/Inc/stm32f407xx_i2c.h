 ...
 * @brief   Header file for I2C driver (Low Layer) for STM32F407xx
 *
 ******************************************************************************
 */
...
typedef struct
{
	uint32_t I2C_SCLSpeed;        /*!< Serial clock speed @I2C_SCL_SPEED */
	uint8_t  I2C_DeviceAddress;   /*!< Device own address (slave mode) */
	uint8_t  I2C_ACKControl;      /*!< ACK control @I2C_ACK_CONTROL */
	uint8_t  I2C_FMDutyCycle;     /*!< Fast mode duty cycle @I2C_FM_DUTY_CYCLE */
} I2C_Config_t;
...
/* Data Send and Receive (Master - blocking) */
void I2C_MasterSendData(I2C_Handle_t *pI2CHandle, uint8_t *pTxBuffer, uint32_t Len, uint8_t SlaveAddr, uint8_t Sr);
void I2C_MasterReceiveData(I2C_Handle_t *pI2CHandle, uint8_t *pRxBuffer, uint8_t Len, uint8_t SlaveAddr, uint8_t Sr);


/* Data Send and Receive (Master - interrupt) */
